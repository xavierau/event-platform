...
class CreateTemporaryRegistrationPageAction
{
    /**
     * Create a new temporary registration page.
     */
    public function execute(TemporaryRegistrationPageData $data): TemporaryRegistrationPage
    {
        return DB::transaction(function () use ($data): TemporaryRegistrationPage {
            $page = TemporaryRegistrationPage::create([
                'title' => $data->title,
