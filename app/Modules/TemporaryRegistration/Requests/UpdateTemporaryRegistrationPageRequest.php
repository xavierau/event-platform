...
class UpdateTemporaryRegistrationPageRequest extends FormRequest
{
    ...
    {
        $page = $this->route('temporary_registration');
        ...
        return [
            ...
            'slug' => [
                ...
                'max:100',
                'regex:/^[a-z0-9-]+$/',
                Rule::unique('temporary_registration_pages', 'slug')->ignore($page),
            ],
