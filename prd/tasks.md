...
| EVT-005.2 | Create Vue component: `EventOccurrenceFormRow.vue`                          | Medium     | EVT-005.1, VEN-001 | Pending    | Inputs for start/end datetime, venue, capacity, status, online details. Includes date/time pickers, venue selector. |
