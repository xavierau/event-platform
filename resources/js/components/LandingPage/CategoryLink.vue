...
defineProps({
  category: {
    type: Object,
    required: true,
    default: () => ({ id: 0, name: 'Unnamed Category', icon: '❓', href: '#' })
  }
});
</script>
