...
<template>
    ...
    <button
        type="button"
        @click="toggleChat"
        class="fixed bottom-20 right-4 z-[1000] flex h-14 w-14 items-center justify-center rounded-full bg-blue-500 text-white shadow-lg transition-all hover:bg-blue-600 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 md:bottom-4 dark:bg-blue-600 dark:hover:bg-blue-700"
