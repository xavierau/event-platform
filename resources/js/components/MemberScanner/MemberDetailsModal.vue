    ...
    <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white dark:bg-gray-800">
          ...
          <div class="space-y-3">
            <div>
              ...
              <input
                ...
                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-gray-200 text-sm"
              />
            </div>
            <div>
      ...
      <div class="flex justify-end space-x-3 p-5 border-t border-gray-200 dark:border-gray-700">
        ...
        <Button
          variant="default"
          @click="$emit('check-in')"
          :disabled="!checkInForm.location || isProcessing || checkInStatus?.success === true"
        >
