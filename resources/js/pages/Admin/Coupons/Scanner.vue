                ...
                <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                    <div v-if="isAdmin && props.events.length > 0" class="mb-6">
                        ...
                        <select
                            ...
                            class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-3 focus:border-indigo-500 sm:text-sm rounded-md"
                        >
                            <option :value="null">
