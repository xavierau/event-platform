<template>
    <Head title="Create Temporary Registration Page" />
    <AppLayout>
        <div class="py-12">
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6 lg:p-8 bg-white dark:bg-gray-800">
                        <PageHeader title="Create Temporary Registration Page">
                            <template #actions>
                                <Link
                        ...
                        <form @submit.prevent="submit" class="mt-8 space-y-6">
                            ...
                            <!-- Banner Image -->
                            <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Banner Image (Optional)</h3>
                            ...
                            <div class="flex items-center justify-end space-x-4 pt-6">
                                ...
                                <Button type="submit" :disabled="form.processing">
                                    {{ form.processing ? 'Creating...' : 'Create Registration Page' }}
                                </Button>
                            </div>
                        </form>
                    </div>
...
const submit = () => {
    ...
    form.post(route('admin.temporary-registration.store'), {
        onSuccess: () => {
