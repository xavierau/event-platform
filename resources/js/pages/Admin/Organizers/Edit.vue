...
const form = useForm({
    ...
    comments_enabled: props.organizer.comments_enabled ?? true,
    comment_config: props.organizer.comment_config ?? 'enabled',
});
                        ...
                        <CardContent>
                           ...
                           <div v-show="currentTab === 'contact'" class="space-y-6">
                            ...
                            <div v-show="currentTab === 'comments'" class="space-y-6">
                                ...
                                <!-- Enable Comments -->
                                <div class="flex items-center space-x-2">
                                    <Switch id="comments_enabled" v-model="form.comments_enabled" />
