  ...
  <div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-lg text-gray-600">Thank you for your purchase. Your booking has been confirmed.</p>
      </div>

      <!-- Transaction Details -->
      <div v-if="transaction" class="bg-white shadow rounded-lg mb-6">
        ...
        <div class="px-6 py-4">
          <dl class="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <dd class="text-sm text-gray-900">{{ formatCurrency(transaction.total_amount, transaction.currency) }}</dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd class="text-sm text-gray-900">{{ formatDate(transaction.updated_at) }}</dd>
            </div>
          </dl>
        </div>
      </div>
      ...
      <!-- Booking Details -->
      <div v-if="bookings && bookings.length > 0" class="bg-white shadow rounded-lg mb-6">
        <div class="px-6 py-4 border-b border-gray-200">
          <h2 class="text-lg font-semibold text-gray-900">Your Tickets</h2>
        </div>
        <div class="px-6 py-4">
          <div class="space-y-4">
            <div v-for="booking in bookings" :key="booking.id" class="border border-gray-200 rounded-lg p-4">
